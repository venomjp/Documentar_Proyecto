...
permalink: /pages/n1-crear-contenido/n2-markdown/n3-modificadoresTexto/index.html
eleventyNavigation:
...
Un **doble salto de línea** genera un nuevo párrafo, mientras que **un solo salto de línea** se interpreta como parte del mismo párrafo.
